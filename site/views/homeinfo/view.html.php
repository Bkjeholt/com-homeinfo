...
/************************************************************************
 ...
 Licence    : ---
 ---------------------------------------------------------
 File       : site/views/homeinfo/view.html.php
 Version    : 0.3.3
 ...
 *
 */
class HomeInfoViewHomeInfo extends JView {
...
/*		$document = JFactory::getDocument();
		$document->addScriptDeclaration('
				window.event(
						"domready", 
						function() {
							getSensorList("com_homeinfo_sensor_list","/cli/com_homeinfo/ajax_sensors.php");
						});
				');
*/
		parent::display($tpl);
